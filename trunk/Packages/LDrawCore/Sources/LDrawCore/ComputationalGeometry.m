...
//========== initWithX:Y:R: ===================================================
//
// Purpose:		Create a circle descriptor used by the LSynth hull / tangent
//				helpers. X/Y are the center; R is the radius.
//
//==============================================================================
...
//========== x ================================================================
//
// Purpose:		Return the circle center's X coordinate.
//
//==============================================================================
- (NSInteger)x
{
...
//========== setX: ============================================================
//
// Purpose:		Set the circle center's X coordinate.
//
//==============================================================================
- (void)setX:(NSInteger)X
{
...
//========== y ================================================================
//
// Purpose:		Return the circle center's Y coordinate.
//
//==============================================================================
- (NSInteger)y {
    return self->y;
...
//========== setY: ============================================================
//
// Purpose:		Set the circle center's Y coordinate.
//
//==============================================================================
- (void)setY:(NSInteger)Y
{
...
//========== r ================================================================
//
// Purpose:		Return the circle radius.
//
//==============================================================================
- (NSInteger)r {
    return self->r;
...
//========== directive ========================================================
//
// Purpose:		Return the LDraw directive associated with this circle, if any.
//
//==============================================================================
- (LDrawDirective *)directive {
