...
//
//================================================================================
struct LDrawPool *		LDrawPoolCreate(void)
{
	struct LDrawPool * ret = (struct LDrawPool *) calloc(1, sizeof(struct LDrawPool));
...
//
//================================================================================
void					LDrawPoolDestroy(struct LDrawPool * pool)
{
	while(pool->first)
	{
...
//
//================================================================================
void *					LDrawPoolAllocate(struct LDrawPool * pool, size_t sz)
{
