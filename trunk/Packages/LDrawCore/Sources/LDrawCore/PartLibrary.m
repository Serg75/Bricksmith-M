...
static PartLibrary *PartLibrary_sharedInstance = nil;

//========== sharedPartLibrary =================================================
//
// Purpose:		Returns the registered renderer's PartLibrary singleton. Model
...
+ (instancetype)sharedPartLibrary
{
	NSAssert(PartLibrary_sharedInstance != nil,
		@"No PartLibrary renderer has registered itself. Either the Metal or "
...
//
// Purpose:		Registers the given (typically renderer-specific) PartLibrary
//				instance as the process-wide shared library. Renderers call
//				this from their `+load` method.
//
//==============================================================================
+ (void)registerSharedPartLibrary:(PartLibrary *)library
{
