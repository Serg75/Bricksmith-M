...
// LDrawModelManager Implementation:
//
...
////////////////////////////////////////////////////////////////////////////////
//
// LDrawModelManager private API
//
////////////////////////////////////////////////////////////////////////////////
@interface LDrawModelManager (private)
...
- (LDrawFile *) beginService:(NSString *) inPartialPath
{
	...
	if(parsedFile)
	{
		...
		[[LDrawModelManager sharedModelManager] documentSignInInternal:fullPath withFile:parsedFile];		
	}
...
@implementation LDrawModelManager

static LDrawModelManager *SharedModelManager = nil;
...
+ (LDrawModelManager *)	sharedModelManager
{
	...
	{
		SharedModelManager = [[LDrawModelManager alloc] init];
	}
