//==============================================================================
//
//  File:       LDrawDisplayList.h
//  Package:    LDrawRenderCore
//
//  Purpose:    Shared display-list C API consumed by LDrawShaderRenderer.
//
//  Info:       Concrete mesh building and GPU upload live in LDrawRenderMetal
//              and LDrawRenderOpenGL; the host app links whichever renderer it
//              needs.
//
...
/*
	...
	The DL API will draw translucent geometry back-to-front ordered (the DLs are reordered, not the
...
void					LDrawDLSessionDrawAndDestroy(LDrawRenderEncoder renderEncoder, struct LDrawDLSession *session);
void					LDrawDLDraw(
