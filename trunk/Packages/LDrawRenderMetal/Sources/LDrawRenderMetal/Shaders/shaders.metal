...
// Include header shared between C code and .metal files. Canonical copy lives
// in the package public headers so CPU and GPU cannot drift apart.
#import "../include/LDrawRenderMetal/MetalCommonDefinitions.h"
