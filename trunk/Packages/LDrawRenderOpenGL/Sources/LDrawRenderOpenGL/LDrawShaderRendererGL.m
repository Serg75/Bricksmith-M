...
//========== builderFinish: ===================================================
//
// Purpose:		Finish the display-list builder and return a GPU display list
//				handle. Implemented by the OpenGL renderer category.
//
//==============================================================================
...
//========== finishDraw: =========================================================
//
// Purpose: Flush deferred display-list draws, render drag handles, and restore
//			fixed-function client state before legacy GL overlay drawing resumes.
//
//================================================================================
- (void)finishDraw
{
	...
	LDrawDLSessionDrawAndDestroy(NULL, session);
	session = nil;
...
//========== dealloc: ============================================================
//
// Purpose: Clean up if the host did not call -finishDraw explicitly.
//
//================================================================================
- (void)dealloc
{
