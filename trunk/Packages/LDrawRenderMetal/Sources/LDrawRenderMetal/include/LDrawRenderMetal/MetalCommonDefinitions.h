//==============================================================================
//
//  File:       MetalCommonDefinitions.h
//  Package:    LDrawRenderMetal
//
//  Purpose:    Header that contains types and enumeration constants shared
//              between Metal shaders and C/Objective-C source.
//
//  Info:       This is the single source of truth for CPU/GPU struct layouts.
//              shaders.metal includes this file via a relative path. Do not
//              add a second copy under Shaders/.
//
