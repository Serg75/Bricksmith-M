...
//---------- load ----------------------------------------------------[static]--
//
// Purpose:		Registers this renderer's shared PartLibrary as the process-wide
//				singleton so generic model code can fetch it through
//				`+[PartLibrary sharedPartLibrary]` without naming the renderer.
//
//------------------------------------------------------------------------------
+ (void)load
{
	[PartLibrary registerSharedPartLibrary:[PartLibraryGL sharedPartLibrary]];
} // end load
