...
- (void)prepareOpenGL
{
	...
	// `-setBackgroundColorRGBA:` (Phase 2g). Until that fires we paint a
	// neutral grey so the renderer stays free of `NSColor.controlBackgroundColor`.
	[self setBackgroundColorRed:0.93 green:0.93 blue:0.93];
