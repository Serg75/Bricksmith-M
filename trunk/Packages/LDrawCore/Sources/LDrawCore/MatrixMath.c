...
//				parameters, create a 4x4 transformation.element matrix used to 
						...
						float		testDepthSoFar)
{
	...
	if(x1 > aabb_ndc[3] ||
	   ...
	   y1 > aabb_ndc[4] ||
	   y2 < aabb_ndc[1] ||
	   testDepthSoFar < aabb_ndc[2])		// If the test depth is LESS than our MIN Z then we ALREADY are closer than this entire test model - skip this model!
	{
		return false;
	}
	return true;
...
//========== SignedAreaOfTriXY =================================================
//
// Purpose:		Signed area of a triangle in XY space — used to calculate
...
//========== PtsCloserThanT2InXY ===============================================
//
// Purpose:		Return true if p1 and p2 are closer than the square root of
