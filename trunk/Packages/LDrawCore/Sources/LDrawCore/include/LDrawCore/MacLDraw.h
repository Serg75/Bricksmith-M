...
//              this file. Host chrome (minifigure, donation, part browser, tool
...
//              Drawing mask bits live on LDrawDirective.h.
//
...
//
// Data types which would otherwise be homeless. SelectionModeT is on
