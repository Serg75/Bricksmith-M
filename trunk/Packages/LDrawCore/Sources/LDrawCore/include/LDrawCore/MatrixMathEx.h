...
//  Package:    LDrawCore
//
//  Purpose:    These APIs operate directly on 16-float column-major matrices,
//              that is, OpenGL's matrix format of choice; they are used to
//              emulate fixed function behavior.
//
