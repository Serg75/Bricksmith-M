...
- (void) nudgeKeyDown:(NSEvent *)theEvent
{
	...
	[self lockContextAndExecute:^
	{
		...
		if([LDrawSelection screenNudge:&actualNudge
							  forArrow:arrow
...
- (void) mousePartSelection:(NSEvent *)theEvent
{
	...
	// I doubt people would discover it.
		...
		selectionMode = [LDrawSelection selectionModeFromModifiers:[theEvent modifierFlags]];
...
- (NSDragOperation) draggingEntered:(id <NSDraggingInfo>)info
{
	...
	[LDrawSelection setSelected:YES forDirectives:directives];
...
//========== LDrawRenderer:mouseIsOverPoint:confidence: ========================
//
...
//========== LDrawRendererMouseNotPositioning: =================================
//
...
//========== LDrawRendererPreferredPartTransform: ==============================
//
...
//========== LDrawRenderer:wantsToSelectDirective:byExtendingSelection: ========
//
...
//========== LDrawRenderer:wantsToSelectDirectives:selectMode ==================
//
...
//========== LDrawRenderer:dragHandleDidMove: ==================================
//
